...
fires_predict_tune = predict(fires_RF,
                          tune,
                          type = "response",
                          predict.all = TRUE)
...
#orkers_RF_improved$confusion

#library(caret)
#confusionMatrix(as.factor(fires_predict_tune$aggregate),as.factor(tune$IncidentDurationMinutes), 
